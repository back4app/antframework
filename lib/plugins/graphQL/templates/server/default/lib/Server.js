...
class Server {
  ...
  _loadApp() {
    ...
    if (this._graphQL) {
      for (const directive of this._graphQL.directiveController.directives) {
        const directiveDefinition = this._graphQL.directiveController
        ...
        for (const fieldName in type._fields) {
          ...
          if (field.astNode && field.astNode.directives) {
            for (const directive of field.astNode.directives) {
              ...
              if (this._graphQL) {
                const antDirective = this._graphQL.directiveController
