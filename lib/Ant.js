...
class Ant {
  ...
  constructor(config) {
    ...
    if (this._config && this._config.defaultRuntime) {
      this._runtimeController.defaultRuntime = Config.ParseConfigDefaultRuntime(
        this._config.defaultRuntime,
        this._runtimeController
      );
    } else if (this._globalConfig && this._globalConfig.defaultRuntime) {
      this._runtimeController.defaultRuntime = Config.ParseConfigDefaultRuntime(
        this._globalConfig.defaultRuntime,
        this._runtimeController
      );
    } else {
